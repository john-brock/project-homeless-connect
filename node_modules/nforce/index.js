...
//var AUTH_ENDPOINT      = 'https://projecthomelessconnect.secure.force.com/services/oauth2/authorize';
var INSTANCE_URL       = 'https://phc-developer-edition.na15.force.com';
var AUTH_ENDPOINT      = 'https://phc-developer-edition.na15.force.com/services/oauth2/authorize';
...
//var LOGIN_URI          = 'https://cs18.salesforce.com/services/oauth2/token';
...
Connection.prototype.apexRest = function(data, callback) {
  ...
  var instanceUrl;
  if(opts.oauth) {
    instanceUrl = opts.oauth.instance.url;
  } else {
    instanceUrl = INSTANCE_URL;
  }
  opts.uri = instanceUrl + '/services/apexrest/' + data.uri;
